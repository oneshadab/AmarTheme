<?php $__env->startSection('content'); ?>
    ...
    <script>
        function checkCart(id){
            ...
            $.ajax({
                type: "GET",
                url: '<?php echo e(route('viewCartREST')); ?>',
        ...
        $(document).ready(function ($) {
            ...
            checkCart(<?php echo e($product['id']); ?>)
                            ...
                            <div class="">
                                <div class=" col-12 carousel-inner p-0">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100 bg-secondary" src="<?php echo e($i); ?>" style="object-fit: contain;" height="440px" width="500px">
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <ol class="carousel-indicators m-0 bg-dark text-right">
                                    ...
                                    <li class="carousel-indicators-li p-1 clickable"  data-target="#product-carousel" data-slide-to="<?php echo e($i); ?>">
                                        <img src="<?php echo e($images[$i]); ?>" height="90px" width="90px" style="object-fit: cover;" align="left">
                                    </li>
                                    <?php endfor; ?>
                                </ol>
                        </div>
            ...
            <div class="col-4">
                <div class="card h-100 rounded-0 text-white shadow-nav">
                    <div class="card-header bg-dark" >
                        <div class="container-fluid">
                            <div class="row mb-0">
                                <div class="col-8">
                                    <div class="row">
                                        <p class="col-12 text-left lead mb-1" style="font-size: 28px;"><?php echo e($product['name']); ?></p>
                                    </div>
                                    <div class="row pb-0">
                    ...
                    <div class="card-body text-secondary" >
                        <ul class="list-group" style="font-size: 15px;font-family: 'Palanquin', sans-serif;">
                            <?php foreach($features as $f): ?>
                                <li class="list-group-item border-0 p-0 pb-2 pl-3"><i class="fas fa-check text-dark" style="font-size: 13px;"></i> <span class="p-2"><?php echo e($f); ?></span></li>
                            <?php endforeach; ?>
                        </ul>
                    ...
                    <div class="card-footer bg-white">
                        ...
                        <div class="row p-1">
                            <button class="btn btn-success btn-block text-white cart-add" data-url="<?php echo e(route('addToCartREST', $product['id'])); ?>" >
                            ...
                            <div class="col-4" >
                                <ul class="list-group h-100" style="font-family: 'Palanquin', sans-serif;">
                                    <?php foreach($info as $i): ?>
                                        <li class="list-group-item"><span class="p-2"><?php echo e($i); ?></span></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>
